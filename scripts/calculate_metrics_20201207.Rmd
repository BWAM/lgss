...
condition <- read.csv(file.path("C:/Data/LGSS_scripting/lgss/data/compile_2015-2019/condition_classes", "2015-2019_LG_condclasses_2021-11-24-reclass.csv")) %>%   
  select(-PC1)
...
# THIS BLOCK USES the 75th of class 1 for ceiling and 25th of class 3 for floor
metrics.thresholds <- metrics.df.standardized.long %>%
  filter(site_id %in% train.df.vec,
         condition_class != 2) %>%
