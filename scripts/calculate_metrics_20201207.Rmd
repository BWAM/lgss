...
```
```{r Final IBI plots, fig.width=3, fig.height=5}
...
metrics.scores %>% 
  ...
  ylab("LG-BAP Score")
ggsave(file.path(root.dir, "data/ibi/plots_for_pub", "ibi_training_final_2021-07-27.png"), dpi = "print")
...
metrics.scores %>% 
  ...
  xlab("Condition Class") +
  ylab("LG-BAP Score") +
  ggsave(file.path(root.dir, "data/ibi/plots_for_pub", "ibi_val_final_2021-07-27.png"), dpi = "print")
...
metrics.scores %>%
  ...
  xlab("Condition Class") +
  ylab("LG-BAP Score") +
  ggsave(file.path(root.dir, "data/ibi/plots_for_pub", "ibi_allsites_final_2021-07-27.png"), dpi = "print")
