...
metrics.scores.plot %>% 
  ...
  # ggsave(file.path(root.dir, "data/ibi/plots_for_pub/rescaling", "ibi_training_2021-12-29.png"), dpi = "print")
...
metrics.scores.plot %>% 
  ...
  # ggsave(file.path(root.dir, "data/ibi/plots_for_pub/rescaling", "ibi_validation_2021-12-29.png"), dpi = "print")
...
metrics.scores.plot %>%
  ...
  xlab("Condition Class") +
  ylab("LGBAP Score") 
  # ggsave(file.path(root.dir, "data/ibi/plots_for_pub/rescaling", "ibi_allsites_2021-12-29.png"), dpi = "print")
