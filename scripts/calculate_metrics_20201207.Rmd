...
metrics.scores %>% 
  ...
  coord_cartesian(ylim = c(0, 10)) +
  geom_boxplot() +
  ggtitle("Final scores (validation)")
...
# ggsave(file.path(root.dir, "data/ibi/reruns/rescaling", "IBI_4met_seed60_2020-06-24_75cl1-25cl3_scaling_VAL.png"), dpi = "screen")
# ggsave(file.path(root.dir, "data/ibi/reruns/rescaling", "IBI_4met_seed60_2020-06-24_95-5_scaling_VAL.png"), dpi = "screen")
...
metrics.scores %>%
  ...
  coord_cartesian(ylim = c(0, 10)) +
  geom_boxplot() +
  ggtitle("LG-BAP Final Scores (all sites)")
# ggsave(file.path(root.dir, "data/ibi/reruns/rescaling", "IBI_4met_seed60_2020-06-24_75cl1-25cl3_scaling_ALL.png"), dpi = "screen")
# ggsave(file.path(root.dir, "data/ibi/reruns/rescaling", "IBI_4met_seed60_2020-06-24_95-5_scaling_ALL.png"), dpi = "screen")
...
####
# need to replace below with updated file if using those code
####
