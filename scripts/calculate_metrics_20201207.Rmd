...
# write.csv(sens.filt, file.path(root.dir, "data/metrics/sens.filt_seed80new_20210114.csv"))
```
...
# metrics.final <- c("dom_5_ttaxa", "pct_gatherer", "rich_ttaxa", "rich_ttaxa_toe", "rich_ttaxa_tol_0to7", "shannon_ttaxa_toe")
...
metrics.scores<-metrics.scores %>%
  group_by(site_id) %>%
  mutate(SITE_SCORE = sum(c(dom_5_ttaxa, pct_gatherer, rich_ttaxa, rich_ttaxa_toe, rich_ttaxa_tol_0to7, shannon_ttaxa_toe, pct_rich_ttaxa_cte))) %>%
  mutate(SITE_SCORE = SITE_SCORE/7) %>%
  ungroup() %>%
  select(site_id, SITE_SCORE, dom_5_ttaxa, pct_gatherer, rich_ttaxa, rich_ttaxa_toe, rich_ttaxa_tol_0to7, shannon_ttaxa_toe, pct_rich_ttaxa_cte)
