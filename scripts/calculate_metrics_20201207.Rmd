...
metrics.scores %>% 
  ...
  geom_boxplot()
ggsave(file.path(root.dir, "data/ibi", "lg_ibi_boxplot_set3_seed80-training.png"), dpi = "screen")
...
metrics.scores %>% 
  ...
  coord_cartesian(ylim=c(0, 100))+
  geom_boxplot()
ggsave(file.path(root.dir, "data/ibi", "lg_ibi_boxplot_set3_seed80-val.png"), dpi = "screen")
...
metrics.scores %>% 
  ...
  coord_cartesian(ylim=c(0, 100))+
  geom_boxplot()
ggsave(file.path(root.dir, "data/ibi", "lg_ibi_boxplot_set3_seed80-val+class2.png"), dpi = "screen")
...
write_csv(train.df, file.path(root.dir, "data/ibi", "lg_ibi_training_seed80_20210105.csv"))
```
