...
# 
# write.csv(test.df, file.path(root.dir, "data/metrics/june2021_rerun/test_subsample_setseed70_allmetrics_2021-06-14.csv"), row.names = F)
# write.csv(train.df, file.path(root.dir, "data/metrics/june2021_rerun/train_subsample_setseed70_allmetrics_2021-06-14.csv"), row.names = F)
