...
```{r Plot metric correlations, fig.width=10, fig.height=10}
library(corrr)
...
correlations.final_rownames <- correlations.final %>%
  # mutate_all(~replace(., is.na(.), 1)) %>% 
  remove_rownames %>% 
  column_to_rownames(var="term")  
  
ggcorrplot::ggcorrplot(correlations.final_rownames)


# corrplot::corrplot(correlations.final_rownames, method="circle")

# col <- colorRampPalette(c("#BB4444", "#EE9988", "#FFFFFF", "#77AADD", "#4477AA"))
# corrplot::corrplot(correlations.final_rownames, method="color", col=col(200),  
