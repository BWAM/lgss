...
```{r, eval= FALSE}
  ...
  ##    Where do the numbers below come from? PMA calculation chunk below? Why eval = FALSE?
...
```{r >50% same values}
#Determine which metrics have >50% same values 
...
```{r SOI}
## Calculate Relative Scope of Impairment
