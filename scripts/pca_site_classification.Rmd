...
#   select(site_id, epifaunal_cover, velocity_depth_regime, riffle_bend_frequency, left_bank_stability, right_bank_stability, left_bank_veg, right_bank_veg, left_bank_veg_zone, right_bank_veg_zone)
# Same as above including fields with missing vals
fielddata.pca.habitatonly <- fielddata.pca.data %>%
...
fielddata.pca.disturb.simp.nat <- fielddata.pca.data.clean %>% 
  select(site_id, landcover_nat_pct, spcond, habitat_total_score)

# Same as above using DEV instead of NAT landcover
fielddata.pca.disturb.simp.dev <- fielddata.pca.data.clean %>% 
  select(site_id, landcover_dev_pct, spcond, habitat_total_score)
...
fielddata.pca.input <- fielddata.pca.disturb.nat %>% 
