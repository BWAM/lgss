...
totcounts_subsamp <- bugs.unique.long %>% 
  select(-final_id) %>% 
  group_by(site_id) %>% 
  summarise(tot = sum(count)) %>% 
  mutate(target = 200,
...
# write_csv(totcounts, file.path(root.dir, "data/compile_2015-2019/bugs/counts", "indiv_counts_orig_2021-12-01.csv"))
# write_csv(totcounts_subsamp, file.path(root.dir, "data/compile_2015-2019/bugs/counts", "indiv_counts_subsamp_2021-12-01.csv"))
...
```{r, eval = FALSE}
write_csv(bugs.unique.long, file.path(root.dir, "data/compile_2015-2019/bugs", "2015-2019_LGtaxa_unique_long_subsamp_2021-11-30.csv"))
...
```{r Add quotes to file for use in PRIMER, eval = FALSE}
