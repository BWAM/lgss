...
field <- read_csv(file.path(root.dir, "data", "compile_2015-2019", "field_data", "final_cleaned", "2015-2019_lowgrad_fielddata_20210526.csv")) %>% 
  ...
  mutate(snag_present = ifelse(lgs_habitat_snag == 0, "N", "Y"),
         snag_present = ifelse(lgs_habitat_snag == -9999, NA, snag_present)) 
  # select(lgs_habitat_snag, snag_present, everything())

write.csv(field, file.path(root.dir, "data", "compile_2015-2019", "field_data", "final_cleaned", "2015-2019_lowgrad_fielddata_2021-11-18.csv"), row.names = FALSE)
```
