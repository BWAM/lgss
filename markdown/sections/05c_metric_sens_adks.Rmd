...
ggsave(filename = "ADK_metrics_2_export.png", width = 7, height = 1.5, units = "in", path = 'C:/Users/gmlemley/OneDrive - New York State Office of Information Technology Services/Projects/LGSS/NAB, NEAEB/Figs/Box plots')

```

```{r}
metrics.vec <- c("pct_rich_mollusca_amphipoda_family",
                 "pct_insecta",
                 "rich_intolerant",
                 "rich_et_macro_genspecies"
                 )

metrics.vec2 <- c("pct_rich_mollusca_amphipoda_family",
                 "pct_insecta",
                 "rich_intolerant",
                 "rich_et_macro_genspecies"
                 )
