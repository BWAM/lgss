...
sw.sens.df %>% 
  ...
  geom_boxplot() +
  scale_fill_manual(values=c("red", "orange", "forest green")) +
  # geom_jitter() +
...
# ggsave(filename = "GL_metrics_2_export.png", width = 7, height = 1.5, units = "in", path = 'C:/Users/gmlemley/OneDrive - New York State Office of Information Technology Services/Projects/LGSS/NAB, NEAEB/Figs/Box plots')
...
sub.df <- reg.df %>% 
  filter(metric %in% metrics.vec) %>% 
  left_join(sw.sens.df, by = "metric") %>% 
  group_by(metric) %>% 
...
# ggsave(filename = "GL_IBI_2_export.png", width = 3, height = 2.5, units = "in", path = 'C:/Users/gmlemley/OneDrive - New York State Office of Information Technology Services/Projects/LGSS/NAB, NEAEB/Figs/Box plots')
```
