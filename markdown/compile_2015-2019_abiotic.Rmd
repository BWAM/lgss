...
itstable.path <- file.path(root.dir, "data", "compile_2015-2019", "ITS_tables_20201027")
...
Read in 2018-2019 data from current version of SBU database, filter, and format
```{r}



# Get list of 2018-2019 LG sites using habitat survey. Should be 39 based on output created in compile_2015-2019_bugs.Rmd
...
# Trasnform from long to wide and add param names for pcodes
db.insitu_all <- read_excel(file.path(itstable.path, "20201020_S_IN_SITU_WATER_CHEM_all_fields.xlsx"), col_types = "text")

db.insitu <- read_excel(file.path(itstable.path, "20201020_S_IN_SITU_WATER_CHEM_all_fields.xlsx"), col_types = "text") %>% 
  rename_all(tolower) %>% 
