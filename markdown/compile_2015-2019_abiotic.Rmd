...
Join 2015-2017 field and habitat, bind with master 2018-2019 table, export.
```{r}
...
write.table(master.field, file.path(root.dir, "data", "compile_2015-2019", "field_data", "final_cleaned", "2015-2019_lowgrad_fielddata_20201117.csv"),sep=",", row.names = FALSE)


```

Get site info for list of sites, add in year to subset.
```{r}
# Only 163 unique sites present.
# Identify which sites were sampled twice and which are new
...
# List sites that are IDs as high gradient in the sites table
...
Addition cleaning on unique values for consistency
```{r}
...
# Still need to harvest StreamStats + landuse data for 2018-2019
